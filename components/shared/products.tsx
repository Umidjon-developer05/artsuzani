          ...
          <CardContent className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border/50">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-suzani-burgundy to-primary hover:opacity-90 text-primary-foreground font-medium px-4 py-2 rounded-lg transition-all duration-300"
              >
                View Details
              </Button>
            </div>
